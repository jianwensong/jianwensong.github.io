...
My research interests focus on 3D vision and point cloud processing. I am dedicated to designing a coding-decoding scheme of fringe projection profilometry to achieve fast and high-precision 3D reconstruction. Recently, I am also trying to apply deep learning to fringe projection profilometry.
\end{rSection}
%--------------------------------------------------------------------------------
