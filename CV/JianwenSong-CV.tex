...
\address{Email: jianwensong6@gmail.com, jianwen.song@unsw.edu.au} % Your phone number and email  Phone: (+86)155xxxxxxxx \\
...
\begin{rSection}{Education}
	{\bf University of New South Wales} \hfill {\em Oct. 2020 - Present}
	\\Doctor of Philosophy, Computer Science and Engineering\\
	Supervisor: Changming Sun, Arcot Sowmya\\
...
\item Kai Liu, Xuening Ran, Jun Gong, {\bf Jianwen Song}, Daniel L Lau, Ce Zhu, and Bin Xu*, ``Extending epipolar geometry for real-time structured light illumination II: lossless accuracy", {\bf Optics Letters}, 2021, 46(4): 837-840. \href{https://www.osapublishing.org/abstract.cfm?uri=ol-46-4-837}{[Paper]}
...
\begin{itemize}[leftmargin=*]
	...
	\item Kai Liu, {\bf Jianwen Song}, Jun Gong, and Ce Zhu, ``Three-dimensional reconstruction method and system based on structured light periodical pattern", Chinese Patent, CN110285775B.
...
\begin{rSection}{Honors and Awards}
	\begin{itemize}[leftmargin=*]
		\item \textbf{Australian Government Research Training Program Scholarship}\hfill {\em Oct. 2020 - Present}
