...
\address{Phone: (+86)15528060815 \\ Email: jianwensong@stu.scu.edu.cn} % Your phone number and email
...
My research interet focuses on structured light illumination and image processing. I am dedicated to designing a coded-decoded scheme of structured light to achieve 3D reconstruction of fast speed and high precision. Recently, I am also trying to apply convolutional neural network to phase measuring profilometry, one of the efficient structured light methods and researching some algorithms of fusing active and passive 3D imaging.
\end{rSection}
%--------------------------------------------------------------------------------
...
\begin{rSection}{Projects}
	\begin{itemize}[leftmargin=*]
		\item  Multi-functional comprehensive experiment and demonstration system for surface structure light high-speed precision three-dimensional shape measurement, supported by Chengdu Zhongliang Electronic Technology Corporation \hfill{\em Jun. 2019}\vspace{1.5mm}\\	
		Task: Construct of the whole system and design the operation interface programmed by C++.
		
		\item  Low-cost high-speed structured light 3D imaging research for product inspection in high-end manufacturing, supported by Science and Technology Support Program of Chengdu City 
		\hfill {\em Sep.2018 - Present}\vspace{1.5mm}\\
		Task: Research on different kinds of coded schemes of structured light illumination and compare their accuracy and efficiency.
		...
		\item  Research on inexpensive real-time high-precision multi-frame structured light 3D face imaging, supported by Beijing Baidu Network Technology Corporation 
		\hfill {\em May. 2018 - Apr. 2019}\vspace{1.5mm}\\
		Task: Design a universal decoding method that can be applied to different coded scheme of structured light illumination.
		...
		Task: Research on the influence of point spread function in structured light system.
		
		\item  Pipeline Analysis System, supported by Seikowave Corporation 
		\hfill {\em Jun. 2017 - Sep. 2018}\vspace{1.5mm}\\		
		Task: Utilize Hough transform to fit the rotation parameter of given pipeline point clouds 
...
\begin{rSection}{Honors and Awards}
	\begin{itemize}[leftmargin=*]
		...
		\item Excellent Undergraduate Student of Sichuan University \hfill {\em Oct. 2016} 
		\item {3$^{\rm rd}$} Prize Scholarship of Sichuan University \hfill {\em Oct. 2016}
