...
My research interest focuses on structured light illumination and image processing. I am dedicated to designing a coding-decoding scheme of structured light to achieve fast and high-precision 3D reconstruction. Recently, I am also trying to apply convolutional neural network to phase measuring profilometry, one of the efficient structured light methods.
\end{rSection}
%--------------------------------------------------------------------------------
