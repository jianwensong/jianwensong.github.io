...
\address{Homepage: https://jianwensong.github.io/CV/}
...
\begin{rSection}{Honors and Awards}
	\begin{itemize}[leftmargin=*]
		...
		\item {1$^{\rm st}$} Ship Model Competition of Sichuan University \hfill {\em Apr. 2014}
		\item ...
	\end{itemize}
...
\begin{rSection}{Projects}
	\begin{itemize}[leftmargin=*]
		\item  Multi-functional comprehensive experiment and demonstration system for surface structure light high-speed precision three-dimensional shape measurement \hfill {\em Jun. 2019}
	
		Charge of the construction of the whole system and the design and C++ programming of the operation interface.
		
		\item  High-precision structured light 3D imaging for illumination saturation overflow and multipath effects supported by the National Natural Science Foundation of China \hfill {\em Sep. 2017 - Dec. 2018}
		
		Research on the high-accuracy and efficient phase unwrapping algorithm for structured light illumination.
