...
My research interest focuses on 3D vision and image processing. I am dedicated to designing a coding-decoding scheme of structured light illumination to achieve fast and high-precision 3D reconstruction. Recently, I am also trying to apply convolutional neural network to phase measuring profilometry, one of the efficient structured light methods.
\end{rSection}
%--------------------------------------------------------------------------------
